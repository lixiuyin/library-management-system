"""
应用配置：优先从环境变量读取，.env 由 python-dotenv 在 backend/ 目录下加载。
...
# 固定从 backend/ 目录加载 .env，与当前工作目录无关
...
# 数据库（连 Docker MySQL 时建议用 127.0.0.1:3306，与 start-mysql.sh 中 root@'127.0.0.1' 对应）
