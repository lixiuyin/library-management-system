<template>
  <div class="app-container-publish" >
    ...
    <el-breadcrumb separator="/" style="font-size: 90%;margin-left: 1%">
      ...
      <el-breadcrumb-item>历史借阅</el-breadcrumb-item>
    </el-breadcrumb>
    <!--搜索表单-->
    <div style="transform: scale(1.3);width: 60%;margin-left: 12%;margin-top: 4%">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="借阅人信息">
          <el-input v-model="searchInfo" placeholder="请输入借阅信息以查找" ></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div style="margin-left: 3%;margin-right: 3%;margin-top: 3%">
      ...
      <template>
        <el-table :data="tableData" style="width: 100%"  max-height="540" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="user_id" label="借阅人id" align="center" width="130%"></el-table-column>
          <el-table-column prop="name" label="借阅人姓名" align="center" width="130%"></el-table-column>
